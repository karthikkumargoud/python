...
# Student records
my_record = [
    (92400133105, 'Karthik Kumar', 'PWP', 98),
    (92400133105, 'Karthik Kumar', 'ICE', 95),
    (92400133105, 'Karthik Kumar', 'DMGT', 92),
    (92400133105, 'Karthik Kumar', 'DSC', 89),
    (92400133105, 'Karthik Kumar', 'SS', 86),
    (92400133105, 'Karthik Kumar', 'COA', 84)
]
cursor.executemany('''
...
cursor.execute('''
    UPDATE my_record 
    SET Mark = 98 
    WHERE Enrollment = 92400133105 AND Subject = 'COA'
''')
conn.commit()
...
cursor.execute('''
    ...
    WHERE Enrollment = 92400133105 AND Subject = 'SS'
''')
conn.commit()
